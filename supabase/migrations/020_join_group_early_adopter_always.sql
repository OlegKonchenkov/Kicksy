-- ============================================================
-- Kicksy - Ensure early_adopter is always awarded on successful join
-- Migration: 020_join_group_early_adopter_always.sql
-- ============================================================
...
BEGIN
  ...
  -- Early adopter: always ensure badge exists for user after successful join.
